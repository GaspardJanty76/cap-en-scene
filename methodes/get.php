...
$sql1 = "SELECT * FROM inscrit WHERE suppr = 0 ORDER BY nom ";
...
if ($resultat1->num_rows > 0) {
    ...
    while ($row = $resultat1->fetch_assoc()) {
        ...
        // Vérifier si "photo" est égal à 1, et si oui, ajouter un attribut "style" pour changer la couleur de fond en rouge
        if ($row["photo"] == 1) {
            echo " style='background-color: rgb(166, 17, 17); color: white'";
        }
